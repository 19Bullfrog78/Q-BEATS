...
**Versione:** V51 — 2026-09-16
**Decisione:** 2026-09-16 — ⚠️ **il campo porta il giorno in cui la decisione è stata presa, NON quello del deposito** (R-δ.15, ratificata Mauro 06/09/2026). La data del deposito non si scrive: vive in git. ⇒ **V51 — il velo dice da dove: tre righe dalla scala di palco, un solo dato per il testo e per il tocco, velo corto sotto la testata, Follower senza gesto (marcatura su «Overlay Standby» e sulla decisione 13), mandato A355; correzioni del referee A356 (16/09: interlinea non costruita, righe ferme dove stavano, riga A a capo, citazioni LIBRO col titolo) dentro la stessa versione — nessun commit fra i due.**
