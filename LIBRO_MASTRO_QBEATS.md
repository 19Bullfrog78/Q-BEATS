...
**Versione:** 19 (proposta, in attesa ratifica esplicita Mauro)
**Ultima modifica:** 2026-06-23 (Rete peer — single-band elevato a **configurazione supportata** per il peer + reti pubbliche/non personali fuori scope + qualifica «pulito»=statico coerente con BUGS v14; sez. 2. Dato tecnico in BUGS v13/v14)
