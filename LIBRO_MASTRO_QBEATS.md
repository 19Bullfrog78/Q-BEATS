...
**Versione:** 21 (RATIFICATA 26/06/2026)
**Ultima modifica:** 2026-06-26 (Schema a **3 container UI**: introdotto **Q-Studio** (pratica, non ancora costruito) + nome tecnico authoring `Studio`→`QStage`; sez. 1 «App e modalità» + sez. 2. Q-Live invariato; metronomo libero escluso dal rename)
