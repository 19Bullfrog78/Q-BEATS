...
**Versione:** 21 (proposta, in attesa ratifica esplicita Mauro)
**Ultima modifica:** 2026-06-25 (Schema a **3 container UI**: introdotto **Q-Studio** (pratica, non ancora costruito) + nome tecnico authoring `Studio`→`QStage`; sez. 1 «App e modalità» + sez. 2. Q-Live invariato; metronomo libero escluso dal rename)
**Edit author:** CC chat principale 12/06/2026
...
| CD-7 | Flusso opt-in modalità collaborativa + interfaccia scelta ruolo (Standalone / Direttore / Follower in menu + Vista LIVE) + popup "nessun Direttore assegnato" (con scaletta) + scenario senza-scaletta (Link libero) + risoluzione collisione naming "Standalone" (modalità vs display "Peers: Standalone") | aperto 2026-06-12 | 2026-06-12 | Direzione ratificata Mauro 12/06 (sez. 2). Disegno = CD. Fattibilità = CC (`BUGS_QBEATS.md` v7 §1.4). Domande residue = sez. 4 CD-Q6. Assorbe: warning UX "Step 2" (`BUGS_QBEATS.md` §1.3) + rework Vista WAITING FOR DIRECTOR (note interim sez. 1) |
...
- **CD-Q6a:** "sempre Standalone" rigido a ogni avvio, oppure l'app **ricorda l'ultima configurazione** (ruolo/modalità)?
